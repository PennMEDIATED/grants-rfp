...
```html
<iframe id="pm-grants-rfp" src="https://pennmediated.github.io/grants-rfp/" title="Grants Request for Proposals — Penn MEDIATED" scrolling="no" loading="lazy" style="width:100%;height:1250px;border:0;display:block"></iframe><script>(function(){var f=document.getElementById('pm-grants-rfp');window.addEventListener('message',function(e){if(e.source!==f.contentWindow)return;var d=e.data||{},h=d.frameHeight||(d.type==='partners-page-resize'?d.height:0);if(h)f.style.height=h+'px';});})();</script>
```
